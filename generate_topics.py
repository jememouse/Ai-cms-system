...
class SEOGenerator:
    ...
    def call_deepseek_generate(self, trend_info):
        ...
        prompt = f"""
        背景：我们是一一家做【{products}】的包装工厂，目标客户是{users}。
        任务：请结合热点话题“{clean_topic}”和我们的包装业务，生成 5 个吸引人的 SEO 标题。
        
        结合角度参考：{angle}
        
        要求：
        1. **字数限制：必须控制在 20 个字以内！短小精悍！**
        2. 必须包含我们的核心产品词（如飞机盒、礼盒等）。
        3. 标题风格要“说人话”，带有“避坑”、“价格揭秘”、“源头”、“拿货”等吸引精准客户的词。
        4. **重要：每个标题只能归属于一个分类，绝对不要出现多个分类**。
        5. 可选分类：【专业知识】、【行业资讯】、【产品介绍】。
